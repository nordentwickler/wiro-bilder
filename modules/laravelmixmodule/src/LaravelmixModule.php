...
class LaravelmixModule extends Module
{
    ...
    {
        Craft::setAlias('@modules/laravelmixmodule', $this->getBasePath());
        $this->controllerNamespace = 'modules\laravelmixmodule\controllers';
        ...
        if (!isset($i18n->translations[$id]) && !isset($i18n->translations[$id.'*'])) {
            $i18n->translations[$id] = [
                ...
                'basePath' => '@modules/laravelmixmodule/translations',
...
//          $extension = new LaravelmixModuleTwigExtension();
        ...
        if (Craft::$app->getRequest()->getIsCpRequest()) {
            Event::on(
                ...
                function (TemplateEvent $event) {
                    try {
                        Craft::$app->getView()->registerAssetBundle(LaravelmixModuleAsset::class);
