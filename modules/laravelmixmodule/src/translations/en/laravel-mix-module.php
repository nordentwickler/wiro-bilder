...
/**
 * laravel-mix en Translation
 *
 * Returns an array with the string to be translated (as passed to `Craft::t('laravel-mix-module', '...')`) as
 ...
 */
return [
    'laravel-mix plugin loaded' => 'laravel-mix plugin loaded',
];
